...
class PaymentService:
    ...
    async def list_unmatched(
        ...
        return PaymentUnmatchedListResp(
            ...
            page=page,
            page_size=page_size,
            items=[PaymentResp(**_payment_to_dict(p, include_unmatched_amount=True)) for p in rows],
        )
    ...
    async def stats(self) -> PaymentStatsResp:
        ...
        matched_amount_d = Decimal(matched_amount) if matched_amount is not None else ZERO
