...
class Plugin(PluginBase):
    ...
    def __init__(self, app: Any = None, config: Optional[dict] = None, manifest: Any = None, **kwargs) -> None:  # noqa: E501
    ...
    async def initialize(self) -> None:
        ...
        logger.info("ddw_payment initialized")

    async def start(self) -> None:
        logger.info("ddw_payment started")

    async def stop(self) -> None:
        logger.info("ddw_payment stopped")
